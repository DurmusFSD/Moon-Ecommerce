  ...
  return (
    <>
      <section className="content flex justify-between lg:px-16 h-[50vh] lg:h-[90vh] relative z-20">
        <div className="left w-1/2 p-8 lg:p-32 lg:py-50">
          <Title
            level={1}
        ...
        <div className="right bg-white p-5 w-1/2 h-full flex justify-center items-center relative z-40  ">
          <img src={image} className="h-[60vh] w-full object-contain" />
        </div>
